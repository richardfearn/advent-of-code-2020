...
class Part1Tests(unittest.TestCase):
    ...
    def test_first_example(self):
        ...
        self.assertEqual(day5.seat_id((44, 5)), 357)

    def test_other_examples(self):

        self.assertEqual(day5.seat_number(EXAMPLE_2), (70, 7))
        self.assertEqual(day5.seat_id(day5.seat_number(EXAMPLE_2)), 567)

        self.assertEqual(day5.seat_number(EXAMPLE_3), (14, 7))
        self.assertEqual(day5.seat_id(day5.seat_number(EXAMPLE_3)), 119)

        self.assertEqual(day5.seat_number(EXAMPLE_4), (102, 4))
        self.assertEqual(day5.seat_id(day5.seat_number(EXAMPLE_4)), 820)
